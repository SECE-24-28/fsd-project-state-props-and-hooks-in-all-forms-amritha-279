...
function Register() {
  ...
  const registerUser = () => {
    ...
    if (
      ...
      return alert("Age must be between 5 and 60.");
    ...
    <>
      ...
      <section className="register-section">
        <div className="register-card">
          ...
          <p className="sub">
            Join Natyalaya and begin your dance journey
          </p>
          ...
          <div className="form-group">
            ...
            >
              ...
              <optgroup label="Regular Batches">
                <option value="Beginner Batch">
                  Beginner Batch
                </option>

                <option value="Intermediate Batch">
                  Intermediate Batch
                </option>

                <option value="Advanced Batch">
                  Advanced Batch
                </option>
              </optgroup>

              <optgroup label="Special Programs">
                <option value="Junior Batch (Kids)">
                  Junior Batch (Kids)
                </option>

                <option value="Arangetram Preparation">
                  Arangetram Preparation
                </option>

                <option value="Weekend Workshop">
                  Weekend Workshop
                </option>
              </optgroup>
            </select>
          ...
          {formData.batch ===
            ...
            <>
              ...
              <div className="form-group">
                <label>
                  Current Guru / Institution
                </label>

                <input
                  type="text"
                  name="currentGuru"
                  value={formData.currentGuru}
                  onChange={handleChange}
                />
              </div>
      ...
      {showModal && (
        <div className="modal-overlay show">
          <div className="modal">
            ...
            <p>
              Welcome to Natya Kala Dance Academy.
              Your sacred dance journey begins here.
            </p>
